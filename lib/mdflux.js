...
var mdFlux = function() {
  this.markdownParser = new mdFluxMarkdown(this);
  this.htmlParser = new mdFluxHTML(this);
}

mdFlux.prototype.setMarkdownParser = function(parser) {
  this.markdownParser.parser = parser;
}

mdFlux.prototype.setHTMLParser = function(parser) {
  this.htmlParser.parser = parser;
}

mdFlux.prototype.toHTML = function(md) {
  return this.markdownParser.convert(md);
}

mdFlux.prototype.addToHTMLPreprocessor = function(namespace, callback) {
  return this.markdownParser.preprocessors.push({
    'namespace': namespace,
    'callback': callback
  })
}

mdFlux.prototype.addToHTMLPostprocessor = function(namespace, callback) {
  return this.markdownParser.postprocessors.push({
    'namespace': namespace,
    'callback': callback
  })
}
...
mdFlux.prototype.addToMarkdownPreprocessor = function(namespace, callback) {
  return this.htmlParser.preprocessors.push({
    'namespace': namespace,
    'callback': callback
  })
}

mdFlux.prototype.addToMarkdownPostprocessor = function(namespace, callback) {
  return this.htmlParser.postprocessors.push({
    'namespace': namespace,
    'callback': callback
  })
}
...
var mdFluxMarkdown = function(mdflux) {
  this.mdflux = mdflux;
  this.parser = null;
  this.processorsSharedSpace = {};
  this.preprocessors = [];
  this.postprocessors = [];
}
...
mdFluxMarkdown.prototype.convert = function(md) {
  var _this = this;
  // pre proccess
  this.preprocessors.forEach(function(processor) {
    if (typeof processor.callback == 'function') {
      md = processor.callback(md, processor.namespace, _this);
    }
  });
  ...
  this.postprocessors.forEach(function(processor) {
    if (typeof processor.callback == 'function') {
      html = processor.callback(html, processor.namespace, _this);
    }
  });
...
var mdFluxHTML = function(mdflux) {
  this.mdflux = mdflux;
  this.parser = null;
  this.processorsSharedSpace = {};
  this.preprocessors = [];
